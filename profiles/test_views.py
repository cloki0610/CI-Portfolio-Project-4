...
class TestProfilesView(TestCase):
    ...
    def test_get_edit_profile(self):
        """ Test get method to render edit_profile.html template """
        self.client.login(username='test', password='password')
    ...
    def test_get_edit_profile_redir(self):
        """
        Test get method to render edit_profile.html template without login
        """
        response = self.client.get('/profiles/edit/')
        self.assertEqual(response.status_code, 302)
    ...
    def test_post_edit_profile(self):
        """ Test post method by EditUserProfileView """
        self.client.login(username='test', password='password')
    ...
    def test_post_edit_profile_invalid(self):
        """ Test post method by EditUserProfileView with invalid input """
        self.client.login(username='test', password='password')
        response = self.client.post('/profiles/edit/', {
            'user_icon': 'iconimg',
    ...
    def test_post_edit_profile_redir(self):
        """ Test post method by EditUserProfileView without login """
        response = self.client.post('/profiles/edit/', {
            'user_icon': 'iconimg',
            'name': 'Test Display Name',
            'location': 'United Kingdom',
    ...
    def test_get_delete_acc(self):
        """ Test get method to render delete_acc.html template """
        self.client.login(username='test', password='password')
    ...
    def test_get_delete_acc_redir(self):
        """
        Test get method to render delete_acc.html template without login
        """
        response = self.client.get('/profiles/delete_account/')
        self.assertEqual(response.status_code, 302)
    ...
    def test_post_delete_action_redir(self):
        """ Test post method by DeleteAction to delete user without login """
    ...
    def test_post_delete_action(self):
        """ Test post method by DeleteAction to delete user """
        self.client.login(username='test', password='password')
        response = self.client.post('/profiles/delete_action/')
